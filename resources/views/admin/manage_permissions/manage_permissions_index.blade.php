        ...
        <div class="row">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12 mt-lg-4 mt-4">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h2 mb-0 text-gray-800 text-info font-weight-bold">Create New Permission</h1>
                                <a href="{{ route('manage_permissions.index') }}" class="d-none d-sm-inline-block btn-sm btn-danger shadow-sm"><i class="fa fa-backward mr-2"></i>
                                    Back
                                </a>
                            </div>
                        </div>
            ...
            <div class="col-md-12 mt-4">
                <div class="card card-body">
                    {!! Form::open(array('route' => 'manage_permissions.store','method'=>'POST')) !!}
                    <div class="row">
