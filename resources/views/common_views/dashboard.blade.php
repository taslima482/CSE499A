                        ...
                        <div class="row m-l-0 m-r-0">
                            ...
                            <div class="col-sm-8">
                                <div class="card-block">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600">Users</p>
                                            <h6 class="text-muted f-w-400"><i class="fa fa-phone text-green mr-2 font-weight-bold" aria-hidden="true"></i>{{ DB::table("users")->count()
                                            }}</h6> 
                                        </div>
                                        {{-- <div class="col-sm-6">
                                            <p class="m-b-10 f-w-600">Tenant</p>
                                            <h6 class="text-muted f-w-400"><i class="fa fa-circle text-green mr-2 font-weight-bold" aria-hidden="true"></i>{{ DB::table("users")->where('tenant_id', 2)->count()
                                            }}</h6> 
                                        </div> --}}
                                    </div>
                                    @endcan
